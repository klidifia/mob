...
`;class e7 extends HTMLElement{#t=null;#e=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open",delegatesFocus:!0}).appendChild(e5.content.cloneNode(!0)),this.shadowRoot&&(this.#t=this.shadowRoot.getElementById("file-input"),this.#e=this.shadowRoot.getElementById("dropzone"))}static get observedAttributes(){return["accept","disabled","multiple"]}attributeChangedCallback(e,t,o){"accept"===e&&t!==o&&this.#t&&(this.#t.accept=this.accept),"disabled"===e&&t!==o&&this.#t&&(this.#t.disabled=this.disabled,this.disabled?(this.#e?.removeAttribute("tabindex"),this.#e?.setAttribute("aria-disabled","true")):(this.#e?.setAttribute("tabindex","0"),this.#e?.setAttribute("aria-disabled","false"))),"multiple"===e&&t!==o&&this.#t&&(this.#t.multiple=this.multiple)}connectedCallback(){this.#s("accept"),this.#s("disabled"),this.#s("maxFiles"),this.#s("maxSize"),this.#s("minSize"),this.#s("multiple"),this.#s("autoFocus"),this.#s("noStyle"),this.#t?.addEventListener("change",this.#i),this.#e?.addEventListener("dragenter",this.#n),this.#e?.addEventListener("dragover",this.#a),this.#e?.addEventListener("dragleave",this.#r),this.#e?.addEventListener("drop",this.#o),this.#e?.addEventListener("click",this.#u),this.#e?.addEventListener("keyup",this.#l),this.autoFocus&&this.#e?.focus()}disconnectedCallback(){this.#t?.removeEventListener("change",this.#i),this.#e?.removeEventListener("dragenter",this.#n),this.#e?.removeEventListener("dragover",this.#a),this.#e?.removeEventListener("dragleave",this.#r),this.#e?.removeEventListener("drop",this.#o),this.#e?.removeEventListener("click",this.#u),this.#e?.removeEventListener("keyup",this.#l)}get accept(){return this.getAttribute("accept")||""}set accept(e){this.setAttribute("accept",null!=e?e.toString():e)}get disabled(){return this.hasAttribute("disabled")}set disabled(e){this.toggleAttribute("disabled",!!e)}get maxFiles(){let e=Number(this.getAttribute("max-files"))||0;return e<=0?1/0:Math.floor(Math.abs(e))}set maxFiles(e){this.setAttribute("max-files",null!=e?e.toString():e)}get maxSize(){let e=this.getAttribute("max-size");if(null===e)return 1/0;let t=Number(e);return Number.isNaN(t)?1/0:t}set maxSize(e){this.setAttribute("max-size",null!=e?e.toString():e)}get minSize(){let e=this.getAttribute("min-size");if(null===e)return 0;let t=Number(e);return Number.isNaN(t)?0:t}set minSize(e){this.setAttribute("min-size",null!=e?e.toString():e)}get multiple(){return this.hasAttribute("multiple")}set multiple(e){this.toggleAttribute("multiple",!!e)}get autoFocus(){return this.hasAttribute("auto-focus")}set autoFocus(e){this.toggleAttribute("auto-focus",!!e)}get noStyle(){return this.hasAttribute("no-style")}set noStyle(e){this.toggleAttribute("no-style",!!e)}#i=async e=>{try{this.#p(await e8(e))}catch(e){this.dispatchEvent(new CustomEvent(`${e3}-error`,{bubbles:!0,composed:!0,detail:{error:e}}))}};#n=()=>{this.disabled||this.dispatchEvent(new Event(`${e3}-dragenter`,{bubbles:!0,composed:!0}))};#a=e=>{if(e.preventDefault(),this.disabled){e.dataTransfer.dropEffect="none";return}e.dataTransfer.dropEffect="copy",this.#e&&(this.#e.classList.add("dropzone--dragover"),this.#e.part.add("dropzone--dragover")),this.dispatchEvent(new Event(`${e3}-dragover`,{bubbles:!0,composed:!0}))};#r=()=>{this.disabled||(this.#e&&(this.#e.classList.remove("dropzone--dragover"),this.#e.part.remove("dropzone--dragover")),this.dispatchEvent(new Event(`${e3}-dragleave`,{bubbles:!0,composed:!0})))};#o=async e=>{if(!this.disabled){e.preventDefault(),this.#e&&(this.#e.classList.remove("dropzone--dragover"),this.#e.part.remove("dropzone--dragover"));try{this.#p(await e8(e))}catch(e){this.dispatchEvent(new CustomEvent(`${e3}-error`,{bubbles:!0,composed:!0,detail:{error:e}}))}}};#u=()=>{this.disabled||this.#t?.click()};#l=e=>{this.disabled||" "!==e.key&&"Enter"!==e.key||this.#t?.click()};#p(e){if(!Array.isArray(e)||!e.length)return;let t=[],o=[],i=e.length;if(!this.multiple&&i>1)for(let t of e)o.push({file:t,errors:[{code:e2,message:"Too many files selected. Only 1 file is allowed."}]});else if(this.multiple&&i>this.maxFiles)for(let t of e)o.push({file:t,errors:[{code:e2,message:`Too many files selected. Only ${this.maxFiles} ${this.maxFiles>1?"files are":"file is"} allowed.`}]});else for(let i of e){let e=function(e,t=""){if(!t)return!0;let o=[...new Set(t.split(",").map(e=>e.trim()).filter(Boolean))],i=e.type,n=i.replace(/\/.*$/,"");for(let t of o)if("."===t.charAt(0)){if(-1!==e.name.toLowerCase().indexOf(t.toLowerCase(),e.name.length-t.length))return!0}else if(/\/\*$/.test(t)){if(n===t.replace(/\/.*$/,""))return!0}else if(i===t)return!0;return!1}(i,this.accept),n=i.size>this.maxSize,a=i.size<this.minSize;if(!e||n||a){let t=[];e||t.push({code:"INVALID_MIME_TYPE",message:`File type "${i.type}" is not accepted.`}),n&&t.push({code:"FILE_TOO_LARGE",message:`File size ${i.size} exceeds the maximum size of ${this.maxSize}.`}),a&&t.push({code:"FILE_TOO_SMALL",message:`File size ${i.size} is smaller than the minimum size of ${this.minSize}.`}),o.push({file:i,errors:t})}else t.push(i)}this.dispatchEvent(new CustomEvent(`${e3}-drop`,{bubbles:!0,composed:!0,detail:{acceptedFiles:t,rejectedFiles:o}})),t.length>0&&this.dispatchEvent(new CustomEvent(`${e3}-drop-accepted`,{bubbles:!0,composed:!0,detail:{acceptedFiles:t}})),o.length>0&&this.dispatchEvent(new CustomEvent(`${e3}-drop-rejected`,{bubbles:!0,composed:!0,detail:{rejectedFiles:o}})),this.#t&&(this.#t.value=this.#t.defaultValue)}openFileDialog(){this.disabled||this.#t?.click()}#s(e){if(Object.prototype.hasOwnProperty.call(this,e)){let t=this[e];delete this[e],this[e]=t}}static defineCustomElement(e=e3){"undefined"==typeof window||window.customElements.get(e)||window.customElements.define(e,e7)}}e7.defineCustomElement();const e9=["image/jpg","image/jpeg","image/png","image/apng","image/gif","image/webp","image/avif"],e6=(e="",t="")=>{let o=Math.random().toString(36).substring(2,8);return`${"string"==typeof e&&""!==e?e+"-":""}${o}${"string"==typeof t&&""!==t?"-"+t:""}`},te=async(e={})=>{let t=await fetch(e.url),o=await t.blob(),i=e.mimeType||o.type||"";if(!e9.includes(i))throw Error(`This is not an accepted image format. Accepted MIME types are: ${e9.join(", ")}`);return new File([o],e.filename||"",o)},tt=localStorage,to=new class{#y=null;#w=null;constructor(e,t=localStorage){if(!e)throw Error("Storage prefix is required");if(t!==localStorage&&t!==sessionStorage)throw Error("Storage provider is not supported");this.#y=e,this.#w=t}set(e,t){try{this.#w.setItem(`${this.#y}${e}`,JSON.stringify(t))}catch(e){console.error("Error saving to storage",e)}}get(e){try{let t=this.#w.getItem(`${this.#y}${e}`);return t?JSON.parse(t):null}catch(e){return console.error("Error getting from storage",e),null}}}("meme-generator/",tt),ti=e=>"string"==typeof e;var tn={};tn=new URL("CloisterBlack.ae9f8d5c.ttf",import.meta.url).toString();var ta={};ta=new URL("Pressuru.684952ea.ttf",import.meta.url).toString();var tr={};tr=new URL("Oswald-Regular.89ec7d89.ttf",import.meta.url).toString();var ts={};ts=new URL("Oswald-Bold.0f6a7ca6.ttf",import.meta.url).toString();var tl={};tl=new URL("Roboto-Regular.ca197847.ttf",import.meta.url).toString();var td={};td=new URL("Roboto-Bold.fdb9b54a.ttf",import.meta.url).toString();var tc={};tc=new URL("RobotoCondensed-Regular.d585f5c7.ttf",import.meta.url).toString();var tu={};tu=new URL("RobotoCondensed-Bold.e1f96d4b.ttf",import.meta.url).toString();var th={};th=new URL("CourierPrime-Regular.3a25a501.ttf",import.meta.url).toString();var tm={};tm=new URL("CourierPrime-Bold.3d6bf689.ttf",import.meta.url).toString();var tp={};tp=new URL("OpenSans-Regular.edf9e01b.ttf",import.meta.url).toString();var tg={};tg=new URL("OpenSans-Bold.8fceb72b.ttf",import.meta.url).toString();const tb=[{name:"CloisterBlack",label:"Cloister Black",path:o(tn),style:"normal",weight:"400"},{name:"Pressuru",label:"Pressuru",path:o(ta),style:"normal",weight:"400"},{name:"Oswald-Regular",label:"Oswald",path:o(tr),style:"normal",weight:"400"},{name:"Oswald-Bold",label:"Oswald Bold",path:o(ts),style:"normal",weight:"700"},{name:"Roboto-Regular",label:"Roboto",path:o(tl),style:"normal",weight:"400"},{name:"Roboto-Bold",label:"Roboto Bold",path:o(td),style:"normal",weight:"700"},{name:"RobotoCondensed-Regular",label:"Roboto Condensed",path:o(tc),style:"normal",weight:"400"},{name:"RobotoCondensed-Bold",label:"Roboto Condensed Bold",path:o(tu),style:"normal",weight:"700"},{name:"CourierPrime-Regular",label:"Courier Prime",path:o(th),style:"normal",weight:"400"},{name:"CourierPrime-Bold",label:"Courier Prime Bold",path:o(tm),style:"normal",weight:"700"},{name:"OpenSans-Regular",label:"Open Sans",path:o(tp),style:"normal",weight:"400"},{name:"OpenSans-Bold",label:"Open Sans Bold",path:o(tg),style:"normal",weight:"400"}],tf=async(e,t,o={})=>{try{let i=new FontFace(e,`url(${t})`,{...o});await i.load(),document.fonts.add(i)}catch(e){console.error(e)}},tv=document.getElementById("errorsContainer"),ty=e=>{let t=e.currentTarget;t.removeEventListener("click",ty),tv.removeChild(t.parentNode)},tw=(e="",t="info")=>{["info","warning","danger"].includes(t)||(t="info");let o=`
  ...
  `,i=document.createElement("div");i.className=`alert alert-${t} alert-dismissible text-break mb-2 fade`,i.innerHTML=o,i.querySelector("button").addEventListener("click",ty),tv.appendChild(i),setTimeout(()=>i.classList.add("show"),100)},tk={id:"",text:"",fillColor:"#ffffff",strokeColor:"#000000",font:"Oswald-Regular",fontSize:90,fontWeight:"normal",textAlign:"center",shadowBlur:0,strokeWidth:0,offsetY:0,offsetX:0,rotate:0,allCaps:!1},tE=new Map;class tx{constructor(e){let t=e6("textbox",Date.now().toString(36));this.data=e?{...e,id:t}:{...tk,id:t},tE.set(t,this),document.dispatchEvent(new CustomEvent("textbox-create",{bubbles:!0,composed:!0,detail:{textbox:this}}))}getData(){return this.data}static create(e){return new tx(e)}static getAll(){return tE}static getById(e){return tE.get(e)}static remove(e){tE.delete(e),document.dispatchEvent(new CustomEvent("textbox-remove",{bubbles:!0,composed:!0,detail:{id:e}}))}static createElement(e,t=!0){if(!(e instanceof tx))return;let o=e.getData(),{id:i,text:n,fillColor:a,strokeColor:r,fontSize:s,shadowBlur:l,strokeWidth:d,offsetX:c,offsetY:u,rotate:h}=o,m=`
    <div class="d-flex align-items-center">
      ...
      <textarea class="form-control meme-text" type="text" data-input="text" autocomplete="off" rows="1" placeholder="Text #${tE.size}">${n}</textarea>
        ...
        <div class="col-4 mb-3">
          ...
          <select class="form-select" data-input="font" id="fontInput_${i}">
            ...
            <optgroup label="Google fonts">
              ${tb.map(({name:e,label:t})=>`<option value="${e}">${t}</option>`)}
            </optgroup>
          </select>
        </div>
  ...
  `,p=document.createDocumentFragment(),g=document.createElement("div");g.setAttribute("id",i),g.setAttribute("data-section","textbox"),g.className="bg-light border shadow-sm mb-3 rounded",g.innerHTML=m,g.querySelectorAll("select").forEach(e=>e.value=o[e.dataset.input]),g.querySelectorAll('input[type="checkbox"]').forEach(e=>e.checked=o[e.dataset.input]);let b=p.appendChild(g);return t&&setTimeout(()=>b.querySelector('[data-input="text"]').focus(),0),b}}class tS{#k=null;#E=null;constructor(e){this.#k=e,this.#E=this.#k.getContext("2d")}get width(){return this.#k.width}set width(e){this.#k.width=e}get height(){return this.#k.height}set height(e){this.#k.height=e}getDimensions(){return{width:this.width,height:this.height}}setDimensions({width:e,height:t}){return this.width=e,this.height=t,this}toDataURL(){return this.#k.toDataURL()}draw(e,t=new Map){if(null==e)return;let o=this.#k,i=this.#E;i.clearRect(0,0,o.width,o.height),ti(e)?(i.fillStyle=e,i.fillRect(0,0,o.width,o.height)):i.drawImage(e,0,0,o.width,o.height);let n=0;return t.forEach(e=>{let{data:t}=e;n+=1,i.save(),i.font=`${t.fontWeight} ${t.fontSize*o.width/1e3}px ${t.font}`,i.fillStyle=t.fillColor,i.textAlign=t.textAlign,i.strokeStyle=t.strokeColor;let a=i.measureText("M").width+t.fontSize/2,r=o.width/2,s=t.shadowBlur,l=(!0===t.allCaps?t.text.toUpperCase():t.text).split("\n");0!==s&&(i.shadowOffsetX=0,i.shadowOffsetY=0,i.shadowBlur=Math.min(s,20),i.shadowColor=t.strokeColor),i.translate(r+t.offsetX,a*n+t.offsetY),i.rotate(Math.min(t.rotate,360)*Math.PI/180),l.forEach((e,t)=>i.fillText(e,0,t*a)),0!==s&&(i.shadowBlur=0,l.forEach((e,t)=>i.fillText(e,0,t*a))),t.strokeWidth>0&&(i.lineWidth=Math.min(t.strokeWidth,20),l.forEach((e,t)=>i.strokeText(e,0,t*a))),i.restore()}),this}clear(){return this.#E.clearRect(0,0,this.#k.width,this.#k.height),this}show(){return this.#k.hidden=!1,this}hide(){return this.#k.hidden=!0,this}static createInstance(e){return new tS(e)}}const tC=tS.createInstance(document.getElementById("canvas")),tj=document.getElementById("videoModal"),tT=document.getElementById("downloadModal"),tA=document.querySelector("files-dropzone"),tL=document.getElementById("instructions"),tz=document.getElementById("imageUploadMethodSelect"),tD=document.getElementById("fileSelectBtn"),t_=document.getElementById("imageUrlForm"),t$=document.getElementById("addTextboxBtn"),tI=document.getElementById("textboxesContainer"),tB=document.getElementById("generateMemeBtn"),tR=document.getElementById("openVideoModalBtn"),tM=document.getElementById("downloadMemeBtn"),tF=document.getElementById("downloadMemePreview"),tN=document.querySelector("web-share"),tO=document.getElementById("gallery"),tP=document.getElementById("gallerySearch"),tU=tO.querySelector(".gallery__no-results"),tq=document.getElementById("solidColorForm"),tH=document.querySelectorAll(".upload-method"),tW=document.getElementById("removeConfirmationModal"),tV=document.getElementById("removeTextForm"),tG=document.getElementById("maxImageDimensionsForm"),tX=tG.maxImageDimensions,tY=document.getElementById("clearCanvasBtn"),tK=to.get("maxImageDimensions");let tJ=!1,tQ=null,tZ=null;const t0=async()=>{let e=tC.toDataURL("image/png"),t=`${e6("meme")}.png`,o=e.replace("image/png","image/octet-stream");if(tM.download=t,tM.href=o,tF.width=tC.getDimensions().width,tF.height=tC.getDimensions().height,tF.src=o,eB())try{let o=await te({url:e,filename:t,mimeType:"image/png"}).catch(e=>tw(e.message,"danger"));o&&eB({files:[o]})&&(tN.shareFiles=[o],tN.hidden=!1)}catch(e){console.error(e)}window.requestAnimationFrame(()=>{tT.open=!0})},t1=e=>{let[t,o]=tG.maxImageDimensions.value.split("x"),i=Number(t)||800,n=Number(o)||600,a=e.width,r=e.height;a>r?a>i&&(r*=i/a,a=i):r>n&&(a*=n/r,r=n),tC.setDimensions({width:a,height:r})},t8=()=>{tC.draw(tQ,tx.getAll()).show(),tA.classList.add("dropzone--accepted"),tA.disabled=!0,tB.disabled=!1,tL.hidden=!0,tY.hidden=!1},t3=e=>{t1(tQ=e.target),t8()},t2=e=>{if(!e)return;let t=new Image,o=new FileReader;o.addEventListener("load",function(e){let o=e.target.result;t.addEventListener("load",t3),t.src=o}),o.readAsDataURL(e)},t5=(e,t,o)=>{let i=tx.getById(t).getData();switch(e.type){case"checkbox":i[o]=e.checked;break;case"number":i[o]=Number(e.value);break;default:i[o]=e.value}tC.draw(tQ,tx.getAll())},t4=async e=>{e.preventDefault();let t=e.target,o=t.querySelector('button[type="submit"]'),i=t.imageUrl.value;if(i.trim()){o.disabled=!0,o.querySelector(".spinner").hidden=!1,o.querySelector(".label").hidden=!0;try{let e=await te({url:i}).catch(e=>tw(e.message,"danger"));e&&t2(e)}catch{tw(`Failed to load image from "${i}".`,"danger")}finally{o.disabled=!1,o.querySelector(".spinner").hidden=!0,o.querySelector(".label").hidden=!1}}},t7=(e,t)=>()=>{let o=document.getElementById(e),i=o.querySelector('[data-input="offsetY"]'),n=o.querySelector('[data-input="offsetX"]'),a=tx.getById(e);if(!a)return;let r=a.getData();switch(t=t.toLowerCase()){case"up":r.offsetY-=1,i.value=r.offsetY;break;case"down":r.offsetY+=1,i.value=r.offsetY;break;case"left":r.offsetX-=1,n.value=r.offsetX;break;case"right":r.offsetX+=1,n.value=r.offsetX}tC.draw(tQ,tx.getAll()),tZ=requestAnimationFrame(t7(e,t))},t9=async e=>{let t=e.target.closest("button");if(!t)return;let o=t.querySelector("img");try{let e=await te({url:o.src}).catch(e=>tw(e.message,"danger"));e&&t2(e)}catch{tw(`Failed to load image: "${o.alt}".`,"danger")}};tD.addEventListener("click",()=>{"function"==typeof tA.openFileDialog&&tA.openFileDialog()}),tR.addEventListener("click",()=>{tj.open=!0}),t$.addEventListener("click",()=>tx.create()),tB.addEventListener("click",t0),tM.addEventListener("click",()=>tT.open=!1),t_.addEventListener("submit",t4),tA.addEventListener("files-dropzone-drop-accepted",e=>{let[t]=e.detail.acceptedFiles;t&&t2(t)}),tI.addEventListener("input",e=>{let t;let o=e.target,i=o.closest('[data-section="textbox"]').id;o.matches('[data-input="text"]')?t="text":o.matches('[data-input="fillColor"]')?t="fillColor":o.matches('[data-input="strokeColor"]')?t="strokeColor":o.matches('[data-input="font"]')?t="font":o.matches('[data-input="fontSize"]')?t="fontSize":o.matches('[data-input="fontWeight"]')?t="fontWeight":o.matches('[data-input="textAlign"]')?t="textAlign":o.matches('[data-input="shadowBlur"]')?t="shadowBlur":o.matches('[data-input="offsetY"]')?t="offsetY":o.matches('[data-input="offsetX"]')?t="offsetX":o.matches('[data-input="rotate"]')?t="rotate":o.matches('[data-input="strokeWidth"]')&&(t="strokeWidth"),t&&t5(o,i,t)}),tI.addEventListener("change",e=>{let t;let o=e.target,i=o.closest('[data-section="textbox"]').id;o.matches('[data-input="allCaps"]')&&(t="allCaps"),t&&t5(o,i,t)}),tI.addEventListener("click",e=>{let t=e.target;if(t.matches('[data-button="settings"]')){let e=t.closest('[data-section="textbox"]'),o=e?.querySelector('[data-section="settings"]');o&&(o.hidden=!o.hidden)}if(t.matches('[data-button="duplicate-text-box"')){let e=t.closest('[data-section="textbox"]'),o=tx.getById(e.id);tx.create({...o.data})}if(t.matches('[data-button="delete-text-box"]')){let e=t.closest('[data-section="textbox"]').id,o=tx.getById(e);if(o&&o.data.text.trim()){let t=tV["textbox-id"];t&&(t.value=e,tW.open=!0)}else tx.remove(e)}}),tI.addEventListener("pointerdown",e=>{let t=e.target,o=t.closest('[data-section="textbox"]');o&&t.matches('[data-action="move-text"]')&&(tZ=requestAnimationFrame(t7(o.id,t.getAttribute("aria-label"))))}),tI.addEventListener("pointerup",e=>{e.target.matches('[data-action="move-text"]')&&(cancelAnimationFrame&&cancelAnimationFrame(tZ),tZ=null)}),tI.addEventListener("pointerout",e=>{e.target.matches('[data-action="move-text"]')&&(cancelAnimationFrame&&cancelAnimationFrame(tZ),tZ=null)}),tI.addEventListener("keydown",e=>{let t=e.target,o=t.closest('[data-section="textbox"]');t.matches('[data-action="move-text"]')&&(" "===e.key||"Enter"===e.key)&&(tZ&&cancelAnimationFrame(tZ),tZ=requestAnimationFrame(t7(o.id,t.getAttribute("aria-label"))))}),tI.addEventListener("keyup",e=>{e.target.matches('[data-action="move-text"]')&&(" "===e.key||"Enter"===e.key)&&(tZ&&cancelAnimationFrame(tZ),tZ=null)}),tz.addEventListener("change",e=>{tH.forEach(t=>t.hidden=t.id!==e.target.value),tG.hidden="solidColorForm"===e.target.value}),tO.addEventListener("click",t9),tP.addEventListener("input",e=>{let t=e.target.value.toLowerCase().trim();tO.querySelectorAll("button").forEach(e=>{let o=(e.querySelector("img").getAttribute("alt")||"").toLowerCase();e.hidden=!o.includes(t)}),tU.hidden=!!tO.querySelector("button:not([hidden])")}),tq.addEventListener("input",e=>{e.target===tq.canvasColor&&(tQ=e.target.value),ti(tQ)&&(tC.setDimensions({width:Number(tq.canvasWidth.value)||800,height:Number(tq.canvasHeight.value)||600}),t8())}),document.addEventListener("web-share:error",()=>{tT.open=!1,tw("There was an error while trying to share your meme.","danger")}),document.addEventListener("capture-photo:error",e=>{let t=e.detail.error,o="An error occurred while trying to capture photo.";t instanceof Error&&("NotAllowedError"===t.name||"NotFoundError"===t.name)&&(o+=" Make sure you have a camera connected and you have granted the appropriate permissions."),tw(o,"danger"),tj.open=!1,console.error(t)}),document.addEventListener("capture-photo:success",e=>{tj.open=!1;let t=new Image;t.addEventListener("load",t3),t.src=e.detail.dataURI}),document.addEventListener("me-open",e=>{if("videoModal"===e.target.id){let e=tj.querySelector("capture-photo");e&&"function"==typeof e.startVideoStream&&e.startVideoStream()}}),document.addEventListener("me-close",e=>{if("videoModal"===e.target.id){let e=tj.querySelector("capture-photo");e&&"function"==typeof e.stopVideoStream&&e.stopVideoStream()}"removeConfirmationModal"===e.target.id&&tV.reset()}),document.addEventListener("emoji-click",e=>{let t=e.target.closest('[data-section="textbox"]');if(t){let o=t.querySelector('[data-input="text"]'),i=e.detail.unicode;o&&eI(o,i)}}),document.addEventListener("textbox-create",e=>{let t=e.detail.textbox,o=tx.createElement(t,tJ);tJ=!0,tI.appendChild(o),t.getData().text&&tC.draw(tQ,tx.getAll())}),document.addEventListener("textbox-remove",e=>{let t=document.getElementById(e.detail.id);t&&t.remove(),tI.querySelectorAll('[data-section="textbox"]').forEach((e,t)=>{e.querySelector('[data-input="text"]').setAttribute("placeholder",`Text #${t+1}`)}),tC.draw(tQ,tx.getAll())}),tV.addEventListener("submit",e=>{e.preventDefault();let t=e.target["textbox-id"].value;t&&(tx.remove(t),tW.open=!1)}),tG.addEventListener("change",e=>{e.target.matches('[name="maxImageDimensions"]')&&to.set("maxImageDimensions",e.target.value),!tQ||ti(tQ)||(t1(tQ),tC.draw(tQ,tx.getAll()))}),tY.addEventListener("click",e=>{tQ&&(e.stopPropagation(),tQ=null,tA.classList.remove("dropzone--accepted"),tB.disabled=!0,tL.hidden=!1,tY.hidden=!0,tA.disabled=!1,tC.clear().hide())}),tO.querySelectorAll("button > img")?.forEach(e=>{e.setAttribute("title",e.getAttribute("alt"))}),tx.create(),tA.accept=e9,tb.forEach(({name:e,path:t,style:o,weight:i})=>{tf(e,t,{style:o,weight:i})}),tK&&(tX.value=tK),tX.disabled=!1;
//# sourceMappingURL=index.0655f30e.js.map
