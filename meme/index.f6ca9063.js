...
`;class tt extends HTMLElement{#t=null;#e=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open",delegatesFocus:!0}).appendChild(e6.content.cloneNode(!0)),this.shadowRoot&&(this.#t=this.shadowRoot.getElementById("file-input"),this.#e=this.shadowRoot.getElementById("dropzone"))}static get observedAttributes(){return["accept","disabled","multiple"]}attributeChangedCallback(e,t,o){"accept"===e&&t!==o&&this.#t&&(this.#t.accept=this.accept),"disabled"===e&&t!==o&&this.#t&&(this.#t.disabled=this.disabled,this.disabled?(this.#e?.removeAttribute("tabindex"),this.#e?.setAttribute("aria-disabled","true")):(this.#e?.setAttribute("tabindex","0"),this.#e?.setAttribute("aria-disabled","false"))),"multiple"===e&&t!==o&&this.#t&&(this.#t.multiple=this.multiple)}connectedCallback(){this.#s("accept"),this.#s("disabled"),this.#s("maxFiles"),this.#s("maxSize"),this.#s("minSize"),this.#s("multiple"),this.#s("autoFocus"),this.#s("noStyle"),this.#t?.addEventListener("change",this.#i),this.#e?.addEventListener("dragenter",this.#n),this.#e?.addEventListener("dragover",this.#a),this.#e?.addEventListener("dragleave",this.#r),this.#e?.addEventListener("drop",this.#o),this.#e?.addEventListener("click",this.#u),this.#e?.addEventListener("keyup",this.#l),this.autoFocus&&this.#e?.focus()}disconnectedCallback(){this.#t?.removeEventListener("change",this.#i),this.#e?.removeEventListener("dragenter",this.#n),this.#e?.removeEventListener("dragover",this.#a),this.#e?.removeEventListener("dragleave",this.#r),this.#e?.removeEventListener("drop",this.#o),this.#e?.removeEventListener("click",this.#u),this.#e?.removeEventListener("keyup",this.#l)}get accept(){return this.getAttribute("accept")||""}set accept(e){this.setAttribute("accept",null!=e?e.toString():e)}get disabled(){return this.hasAttribute("disabled")}set disabled(e){this.toggleAttribute("disabled",!!e)}get maxFiles(){let e=Number(this.getAttribute("max-files"))||0;return e<=0?1/0:Math.floor(Math.abs(e))}set maxFiles(e){this.setAttribute("max-files",null!=e?e.toString():e)}get maxSize(){let e=this.getAttribute("max-size");if(null===e)return 1/0;let t=Number(e);return Number.isNaN(t)?1/0:t}set maxSize(e){this.setAttribute("max-size",null!=e?e.toString():e)}get minSize(){let e=this.getAttribute("min-size");if(null===e)return 0;let t=Number(e);return Number.isNaN(t)?0:t}set minSize(e){this.setAttribute("min-size",null!=e?e.toString():e)}get multiple(){return this.hasAttribute("multiple")}set multiple(e){this.toggleAttribute("multiple",!!e)}get autoFocus(){return this.hasAttribute("auto-focus")}set autoFocus(e){this.toggleAttribute("auto-focus",!!e)}get noStyle(){return this.hasAttribute("no-style")}set noStyle(e){this.toggleAttribute("no-style",!!e)}#i=async e=>{try{this.#p(await e4(e))}catch(e){this.dispatchEvent(new CustomEvent(`${e9}-error`,{bubbles:!0,composed:!0,detail:{error:e}}))}};#n=()=>{this.disabled||this.dispatchEvent(new Event(`${e9}-dragenter`,{bubbles:!0,composed:!0}))};#a=e=>{if(e.preventDefault(),this.disabled){e.dataTransfer.dropEffect="none";return}e.dataTransfer.dropEffect="copy",this.#e&&(this.#e.classList.add("dropzone--dragover"),this.#e.part.add("dropzone--dragover")),this.dispatchEvent(new Event(`${e9}-dragover`,{bubbles:!0,composed:!0}))};#r=()=>{this.disabled||(this.#e&&(this.#e.classList.remove("dropzone--dragover"),this.#e.part.remove("dropzone--dragover")),this.dispatchEvent(new Event(`${e9}-dragleave`,{bubbles:!0,composed:!0})))};#o=async e=>{if(!this.disabled){e.preventDefault(),this.#e&&(this.#e.classList.remove("dropzone--dragover"),this.#e.part.remove("dropzone--dragover"));try{this.#p(await e4(e))}catch(e){this.dispatchEvent(new CustomEvent(`${e9}-error`,{bubbles:!0,composed:!0,detail:{error:e}}))}}};#u=()=>{this.disabled||this.#t?.click()};#l=e=>{this.disabled||" "!==e.key&&"Enter"!==e.key||this.#t?.click()};#p(e){if(!Array.isArray(e)||!e.length)return;let t=[],o=[],i=e.length;if(!this.multiple&&i>1)for(let t of e)o.push({file:t,errors:[{code:e7,message:"Too many files selected. Only 1 file is allowed."}]});else if(this.multiple&&i>this.maxFiles)for(let t of e)o.push({file:t,errors:[{code:e7,message:`Too many files selected. Only ${this.maxFiles} ${this.maxFiles>1?"files are":"file is"} allowed.`}]});else for(let i of e){let e=function(e,t=""){if(!t)return!0;let o=[...new Set(t.split(",").map(e=>e.trim()).filter(Boolean))],i=e.type,n=i.replace(/\/.*$/,"");for(let t of o)if("."===t.charAt(0)){if(-1!==e.name.toLowerCase().indexOf(t.toLowerCase(),e.name.length-t.length))return!0}else if(/\/\*$/.test(t)){if(n===t.replace(/\/.*$/,""))return!0}else if(i===t)return!0;return!1}(i,this.accept),n=i.size>this.maxSize,a=i.size<this.minSize;if(!e||n||a){let t=[];e||t.push({code:"INVALID_MIME_TYPE",message:`File type "${i.type}" is not accepted.`}),n&&t.push({code:"FILE_TOO_LARGE",message:`File size ${i.size} exceeds the maximum size of ${this.maxSize}.`}),a&&t.push({code:"FILE_TOO_SMALL",message:`File size ${i.size} is smaller than the minimum size of ${this.minSize}.`}),o.push({file:i,errors:t})}else t.push(i)}this.dispatchEvent(new CustomEvent(`${e9}-drop`,{bubbles:!0,composed:!0,detail:{acceptedFiles:t,rejectedFiles:o}})),t.length>0&&this.dispatchEvent(new CustomEvent(`${e9}-drop-accepted`,{bubbles:!0,composed:!0,detail:{acceptedFiles:t}})),o.length>0&&this.dispatchEvent(new CustomEvent(`${e9}-drop-rejected`,{bubbles:!0,composed:!0,detail:{rejectedFiles:o}})),this.#t&&(this.#t.value=this.#t.defaultValue)}openFileDialog(){this.disabled||this.#t?.click()}#s(e){if(Object.prototype.hasOwnProperty.call(this,e)){let t=this[e];delete this[e],this[e]=t}}static defineCustomElement(e=e9){"undefined"==typeof window||window.customElements.get(e)||window.customElements.define(e,tt)}}tt.defineCustomElement();let to=["image/jpg","image/jpeg","image/png","image/apng","image/gif","image/webp","image/avif"],ti=(e="",t="")=>{let o=Math.random().toString(36).substring(2,8);return`${"string"==typeof e&&""!==e?e+"-":""}${o}${"string"==typeof t&&""!==t?"-"+t:""}`},tn=async(e={})=>{let t=await fetch(e.url),o=await t.blob(),i=e.mimeType||o.type||"";if(!to.includes(i))throw Error(`This is not an accepted image format. Accepted MIME types are: ${to.join(", ")}`);return new File([o],e.filename||"",o)},ta=localStorage,tr=new class{#y=null;#w=null;constructor(e,t=localStorage){if(!e)throw Error("Storage prefix is required");if(t!==localStorage&&t!==sessionStorage)throw Error("Storage provider is not supported");this.#y=e,this.#w=t}set(e,t){try{this.#w.setItem(`${this.#y}${e}`,JSON.stringify(t))}catch(e){console.error("Error saving to storage",e)}}get(e){try{let t=this.#w.getItem(`${this.#y}${e}`);return t?JSON.parse(t):null}catch(e){return console.error("Error getting from storage",e),null}}}("meme-generator/",ta),ts=e=>"string"==typeof e;var tl={};tl=s("aNJCr").getBundleURL("9p9yL")+"CloisterBlack.ae9f8d5c.ttf";var td={};td=s("aNJCr").getBundleURL("9p9yL")+"Pressuru.684952ea.ttf";var tc={};tc=s("aNJCr").getBundleURL("9p9yL")+"Oswald-Regular.89ec7d89.ttf";var tu={};tu=s("aNJCr").getBundleURL("9p9yL")+"Oswald-Bold.0f6a7ca6.ttf";var th={};th=s("aNJCr").getBundleURL("9p9yL")+"Roboto-Regular.ca197847.ttf";var tm={};tm=s("aNJCr").getBundleURL("9p9yL")+"Roboto-Bold.fdb9b54a.ttf";var tp={};tp=s("aNJCr").getBundleURL("9p9yL")+"RobotoCondensed-Regular.d585f5c7.ttf";var tg={};tg=s("aNJCr").getBundleURL("9p9yL")+"RobotoCondensed-Bold.e1f96d4b.ttf";var tb={};tb=s("aNJCr").getBundleURL("9p9yL")+"CourierPrime-Regular.3a25a501.ttf";var tf={};tf=s("aNJCr").getBundleURL("9p9yL")+"CourierPrime-Bold.3d6bf689.ttf";var tv={};tv=s("aNJCr").getBundleURL("9p9yL")+"OpenSans-Regular.edf9e01b.ttf";var ty={};ty=s("aNJCr").getBundleURL("9p9yL")+"OpenSans-Bold.8fceb72b.ttf";let tw=[{name:"CloisterBlack",label:"Cloister Black",path:o(tl),style:"normal",weight:"400"},{name:"Pressuru",label:"Pressuru",path:o(td),style:"normal",weight:"400"},{name:"Oswald-Regular",label:"Oswald",path:o(tc),style:"normal",weight:"400"},{name:"Oswald-Bold",label:"Oswald Bold",path:o(tu),style:"normal",weight:"700"},{name:"Roboto-Regular",label:"Roboto",path:o(th),style:"normal",weight:"400"},{name:"Roboto-Bold",label:"Roboto Bold",path:o(tm),style:"normal",weight:"700"},{name:"RobotoCondensed-Regular",label:"Roboto Condensed",path:o(tp),style:"normal",weight:"400"},{name:"RobotoCondensed-Bold",label:"Roboto Condensed Bold",path:o(tg),style:"normal",weight:"700"},{name:"CourierPrime-Regular",label:"Courier Prime",path:o(tb),style:"normal",weight:"400"},{name:"CourierPrime-Bold",label:"Courier Prime Bold",path:o(tf),style:"normal",weight:"700"},{name:"OpenSans-Regular",label:"Open Sans",path:o(tv),style:"normal",weight:"400"},{name:"OpenSans-Bold",label:"Open Sans Bold",path:o(ty),style:"normal",weight:"400"}],tk=async(e,t,o={})=>{try{let i=new FontFace(e,`url(${t})`,{...o});await i.load(),document.fonts.add(i)}catch(e){console.error(e)}},tE=document.getElementById("errorsContainer"),tx=e=>{let t=e.currentTarget;t.removeEventListener("click",tx),tE.removeChild(t.parentNode)},tS=(e="",t="info")=>{["info","warning","danger"].includes(t)||(t="info");let o=`
        ...
        <div class="col-4 mb-3">
          ...
          <select class="form-select" data-input="font" id="fontInput_${i}">
            ...
            <optgroup label="Google fonts">
              ${tw.map(({name:e,label:t})=>`<option value="${e}">${t}</option>`)}
            </optgroup>
          </select>
        </div>
  ...
  `,p=document.createDocumentFragment(),g=document.createElement("div");g.setAttribute("id",i),g.setAttribute("data-section","textbox"),g.className="bg-light border shadow-sm mb-3 rounded",g.innerHTML=m,g.querySelectorAll("select").forEach(e=>e.value=o[e.dataset.input]),g.querySelectorAll('input[type="checkbox"]').forEach(e=>e.checked=o[e.dataset.input]);let b=p.appendChild(g);return t&&setTimeout(()=>b.querySelector('[data-input="text"]').focus(),0),b}}class tA{#k=null;#E=null;constructor(e){this.#k=e,this.#E=this.#k.getContext("2d")}get width(){return this.#k.width}set width(e){this.#k.width=e}get height(){return this.#k.height}set height(e){this.#k.height=e}getDimensions(){return{width:this.width,height:this.height}}setDimensions({width:e,height:t}){return this.width=e,this.height=t,this}toDataURL(){return this.#k.toDataURL()}draw(e,t=new Map){if(null==e)return;let o=this.#k,i=this.#E;i.clearRect(0,0,o.width,o.height),ts(e)?(i.fillStyle=e,i.fillRect(0,0,o.width,o.height)):i.drawImage(e,0,0,o.width,o.height);let n=0;return t.forEach(e=>{let{data:t}=e;n+=1,i.save(),i.font=`${t.fontWeight} ${t.fontSize*o.width/1e3}px ${t.font}`,i.fillStyle=t.fillColor,i.textAlign=t.textAlign,i.strokeStyle=t.strokeColor;let a=i.measureText("M").width+t.fontSize/2,r=o.width/2,s=t.shadowBlur,l=(!0===t.allCaps?t.text.toUpperCase():t.text).split("\n");0!==s&&(i.shadowOffsetX=0,i.shadowOffsetY=0,i.shadowBlur=Math.min(s,20),i.shadowColor=t.strokeColor),i.translate(r+t.offsetX,a*n+t.offsetY),i.rotate(Math.min(t.rotate,360)*Math.PI/180),l.forEach((e,t)=>i.fillText(e,0,t*a)),0!==s&&(i.shadowBlur=0,l.forEach((e,t)=>i.fillText(e,0,t*a))),t.strokeWidth>0&&(i.lineWidth=Math.min(t.strokeWidth,20),l.forEach((e,t)=>i.strokeText(e,0,t*a))),i.restore()}),this}clear(){return this.#E.clearRect(0,0,this.#k.width,this.#k.height),this}show(){return this.#k.hidden=!1,this}hide(){return this.#k.hidden=!0,this}static createInstance(e){return new tA(e)}}let tL=tA.createInstance(document.getElementById("canvas")),tz=document.getElementById("videoModal"),tD=document.getElementById("downloadModal"),t_=document.querySelector("files-dropzone"),t$=document.getElementById("instructions"),tI=document.getElementById("imageUploadMethodSelect"),tB=document.getElementById("fileSelectBtn"),tR=document.getElementById("imageUrlForm"),tM=document.getElementById("addTextboxBtn"),tN=document.getElementById("textboxesContainer"),tF=document.getElementById("generateMemeBtn"),tO=document.getElementById("openVideoModalBtn"),tP=document.getElementById("downloadMemeBtn"),tU=document.getElementById("downloadMemePreview"),tq=document.querySelector("web-share"),tH=document.getElementById("gallery"),tW=document.getElementById("gallerySearch"),tV=tH.querySelector(".gallery__no-results"),tG=document.getElementById("solidColorForm"),tX=document.querySelectorAll(".upload-method"),tY=document.getElementById("removeConfirmationModal"),tJ=document.getElementById("removeTextForm"),tK=document.getElementById("maxImageDimensionsForm"),tQ=tK.maxImageDimensions,tZ=document.getElementById("clearCanvasBtn"),t0=tr.get("maxImageDimensions"),t1=!1,t8=null,t3=null,t2=async()=>{let e=tL.toDataURL("image/png"),t=`${ti("meme")}.png`,o=e.replace("image/png","image/octet-stream");if(tP.download=t,tP.href=o,tU.width=tL.getDimensions().width,tU.height=tL.getDimensions().height,tU.src=o,eF())try{let o=await tn({url:e,filename:t,mimeType:"image/png"}).catch(e=>tS(e.message,"danger"));o&&eF({files:[o]})&&(tq.shareFiles=[o],tq.hidden=!1)}catch(e){console.error(e)}window.requestAnimationFrame(()=>{tD.open=!0})},t5=e=>{let[t,o]=tK.maxImageDimensions.value.split("x"),i=Number(t)||800,n=Number(o)||600,a=e.width,r=e.height;a>r?a>i&&(r*=i/a,a=i):r>n&&(a*=n/r,r=n),tL.setDimensions({width:a,height:r})},t4=()=>{tL.draw(t8,tT.getAll()).show(),t_.classList.add("dropzone--accepted"),t_.disabled=!0,tF.disabled=!1,t$.hidden=!0,tZ.hidden=!1},t9=e=>{t5(t8=e.target),t4()},t7=e=>{if(!e)return;let t=new Image,o=new FileReader;o.addEventListener("load",function(e){let o=e.target.result;t.addEventListener("load",t9),t.src=o}),o.readAsDataURL(e)},t6=(e,t,o)=>{let i=tT.getById(t).getData();switch(e.type){case"checkbox":i[o]=e.checked;break;case"number":i[o]=Number(e.value);break;default:i[o]=e.value}tL.draw(t8,tT.getAll())},oe=async e=>{e.preventDefault();let t=e.target,o=t.querySelector('button[type="submit"]'),i=t.imageUrl.value;if(i.trim()){o.disabled=!0,o.querySelector(".spinner").hidden=!1,o.querySelector(".label").hidden=!0;try{let e=await tn({url:i}).catch(e=>tS(e.message,"danger"));e&&t7(e)}catch{tS(`Failed to load image from "${i}".`,"danger")}finally{o.disabled=!1,o.querySelector(".spinner").hidden=!0,o.querySelector(".label").hidden=!1}}},ot=(e,t)=>()=>{let o=document.getElementById(e),i=o.querySelector('[data-input="offsetY"]'),n=o.querySelector('[data-input="offsetX"]'),a=tT.getById(e);if(!a)return;let r=a.getData();switch(t=t.toLowerCase()){case"up":r.offsetY-=1,i.value=r.offsetY;break;case"down":r.offsetY+=1,i.value=r.offsetY;break;case"left":r.offsetX-=1,n.value=r.offsetX;break;case"right":r.offsetX+=1,n.value=r.offsetX}tL.draw(t8,tT.getAll()),t3=requestAnimationFrame(ot(e,t))},oo=async e=>{let t=e.target.closest("button");if(!t)return;let o=t.querySelector("img");try{let e=await tn({url:o.src}).catch(e=>tS(e.message,"danger"));e&&t7(e)}catch{tS(`Failed to load image: "${o.alt}".`,"danger")}};tB.addEventListener("click",()=>{"function"==typeof t_.openFileDialog&&t_.openFileDialog()}),tO.addEventListener("click",()=>{tz.open=!0}),tM.addEventListener("click",()=>tT.create()),tF.addEventListener("click",t2),tP.addEventListener("click",()=>tD.open=!1),tR.addEventListener("submit",oe),t_.addEventListener("files-dropzone-drop-accepted",e=>{let[t]=e.detail.acceptedFiles;t&&t7(t)}),tN.addEventListener("input",e=>{let t;let o=e.target,i=o.closest('[data-section="textbox"]').id;o.matches('[data-input="text"]')?t="text":o.matches('[data-input="fillColor"]')?t="fillColor":o.matches('[data-input="strokeColor"]')?t="strokeColor":o.matches('[data-input="font"]')?t="font":o.matches('[data-input="fontSize"]')?t="fontSize":o.matches('[data-input="fontWeight"]')?t="fontWeight":o.matches('[data-input="textAlign"]')?t="textAlign":o.matches('[data-input="shadowBlur"]')?t="shadowBlur":o.matches('[data-input="offsetY"]')?t="offsetY":o.matches('[data-input="offsetX"]')?t="offsetX":o.matches('[data-input="rotate"]')?t="rotate":o.matches('[data-input="strokeWidth"]')&&(t="strokeWidth"),t&&t6(o,i,t)}),tN.addEventListener("change",e=>{let t;let o=e.target,i=o.closest('[data-section="textbox"]').id;o.matches('[data-input="allCaps"]')&&(t="allCaps"),t&&t6(o,i,t)}),tN.addEventListener("click",e=>{let t=e.target;if(t.matches('[data-button="settings"]')){let e=t.closest('[data-section="textbox"]'),o=e?.querySelector('[data-section="settings"]');o&&(o.hidden=!o.hidden)}if(t.matches('[data-button="duplicate-text-box"')){let e=t.closest('[data-section="textbox"]'),o=tT.getById(e.id);tT.create({...o.data})}if(t.matches('[data-button="delete-text-box"]')){let e=t.closest('[data-section="textbox"]').id,o=tT.getById(e);if(o&&o.data.text.trim()){let t=tJ["textbox-id"];t&&(t.value=e,tY.open=!0)}else tT.remove(e)}}),tN.addEventListener("pointerdown",e=>{let t=e.target,o=t.closest('[data-section="textbox"]');o&&t.matches('[data-action="move-text"]')&&(t3=requestAnimationFrame(ot(o.id,t.getAttribute("aria-label"))))}),tN.addEventListener("pointerup",e=>{e.target.matches('[data-action="move-text"]')&&(cancelAnimationFrame&&cancelAnimationFrame(t3),t3=null)}),tN.addEventListener("pointerout",e=>{e.target.matches('[data-action="move-text"]')&&(cancelAnimationFrame&&cancelAnimationFrame(t3),t3=null)}),tN.addEventListener("keydown",e=>{let t=e.target,o=t.closest('[data-section="textbox"]');t.matches('[data-action="move-text"]')&&(" "===e.key||"Enter"===e.key)&&(t3&&cancelAnimationFrame(t3),t3=requestAnimationFrame(ot(o.id,t.getAttribute("aria-label"))))}),tN.addEventListener("keyup",e=>{e.target.matches('[data-action="move-text"]')&&(" "===e.key||"Enter"===e.key)&&(t3&&cancelAnimationFrame(t3),t3=null)}),tI.addEventListener("change",e=>{tX.forEach(t=>t.hidden=t.id!==e.target.value),tK.hidden="solidColorForm"===e.target.value}),tH.addEventListener("click",oo),tW.addEventListener("input",e=>{let t=e.target.value.toLowerCase().trim();tH.querySelectorAll("button").forEach(e=>{let o=(e.querySelector("img").getAttribute("alt")||"").toLowerCase();e.hidden=!o.includes(t)}),tV.hidden=!!tH.querySelector("button:not([hidden])")}),tG.addEventListener("input",e=>{e.target===tG.canvasColor&&(t8=e.target.value),ts(t8)&&(tL.setDimensions({width:Number(tG.canvasWidth.value)||800,height:Number(tG.canvasHeight.value)||600}),t4())}),document.addEventListener("web-share:error",()=>{tD.open=!1,tS("There was an error while trying to share your meme.","danger")}),document.addEventListener("capture-photo:error",e=>{let t=e.detail.error,o="An error occurred while trying to capture photo.";t instanceof Error&&("NotAllowedError"===t.name||"NotFoundError"===t.name)&&(o+=" Make sure you have a camera connected and you have granted the appropriate permissions."),tS(o,"danger"),tz.open=!1,console.error(t)}),document.addEventListener("capture-photo:success",e=>{tz.open=!1;let t=new Image;t.addEventListener("load",t9),t.src=e.detail.dataURI}),document.addEventListener("me-open",e=>{if("videoModal"===e.target.id){let e=tz.querySelector("capture-photo");e&&"function"==typeof e.startVideoStream&&e.startVideoStream()}}),document.addEventListener("me-close",e=>{if("videoModal"===e.target.id){let e=tz.querySelector("capture-photo");e&&"function"==typeof e.stopVideoStream&&e.stopVideoStream()}"removeConfirmationModal"===e.target.id&&tJ.reset()}),document.addEventListener("emoji-click",e=>{let t=e.target.closest('[data-section="textbox"]');if(t){let o=t.querySelector('[data-input="text"]'),i=e.detail.unicode;o&&eN(o,i)}}),document.addEventListener("textbox-create",e=>{let t=e.detail.textbox,o=tT.createElement(t,t1);t1=!0,tN.appendChild(o),t.getData().text&&tL.draw(t8,tT.getAll())}),document.addEventListener("textbox-remove",e=>{let t=document.getElementById(e.detail.id);t&&t.remove(),tN.querySelectorAll('[data-section="textbox"]').forEach((e,t)=>{e.querySelector('[data-input="text"]').setAttribute("placeholder",`Text #${t+1}`)}),tL.draw(t8,tT.getAll())}),tJ.addEventListener("submit",e=>{e.preventDefault();let t=e.target["textbox-id"].value;t&&(tT.remove(t),tY.open=!1)}),tK.addEventListener("change",e=>{e.target.matches('[name="maxImageDimensions"]')&&tr.set("maxImageDimensions",e.target.value),!t8||ts(t8)||(t5(t8),tL.draw(t8,tT.getAll()))}),tZ.addEventListener("click",e=>{t8&&(e.stopPropagation(),t8=null,t_.classList.remove("dropzone--accepted"),tF.disabled=!0,t$.hidden=!1,tZ.hidden=!0,t_.disabled=!1,tL.clear().hide())}),tH.querySelectorAll("button > img")?.forEach(e=>{e.setAttribute("title",e.getAttribute("alt"))}),tT.create(),t_.accept=to,tw.forEach(({name:e,path:t,style:o,weight:i})=>{tk(e,t,{style:o,weight:i})}),t0&&(tQ.value=t0),tQ.disabled=!1}();
//# sourceMappingURL=index.f6ca9063.js.map
